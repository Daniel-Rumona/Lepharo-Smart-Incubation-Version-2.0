...
exports.moderateCadencePhase = void 0;
/**
 ...
 */
function moderateCadencePhase(daysSince) {
    if (daysSince < 2)
        return null;
    if (daysSince < 5)
        return "day-2";
...
exports.moderateCadencePhase = moderateCadencePhase;
//# sourceMappingURL=reminderCadence.js.map